...
<div class="container mb-5 mt-5 d-flex">
  <div class="col-md-3 class_icon m-auto pl-0 pr-0">
    <div class="circle bg-dark m-auto p-auto">
  ...
  <div class="class_description col-md-3 row border border-dark">
    <div class="rect m-auto p-auto">
      <div>
